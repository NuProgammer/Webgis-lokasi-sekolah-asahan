...
lyr_ADMINISTRASIKECAMATAN_AR_50K_0.setVisible(true);lyr_koordinat_1.setVisible(true);
var layersList = [lyr_ADMINISTRASIKECAMATAN_AR_50K_0,lyr_koordinat_1];
...
lyr_koordinat_1.set('fieldAliases', {'id': 'id', 'keterangan': 'keterangan', 'informasi': 'informasi', 'foto': 'foto', });
...
lyr_koordinat_1.set('fieldImages', {'id': 'TextEdit', 'keterangan': 'TextEdit', 'informasi': 'TextEdit', 'foto': 'ExternalResource', });
...
lyr_koordinat_1.set('fieldLabels', {'id': 'no label', 'keterangan': 'no label', 'informasi': 'no label', 'foto': 'no label', });
lyr_koordinat_1.on('precompose', function(evt) {
